<template>
    <div class="text-center">
        ...
        <h2 class="text-xl font-extrabold ">Logging in, please wait</h2>

        <!-- Animated svg for loading -->

        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="mx-auto" style="shape-rendering: auto;" width="244px" height="244px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
            <g transform="rotate(0 50 50)">
                <rect x="47" y="24" rx="3" ry="6" width="6" height="12" fill="#e5e7eb">
...
// TODO If there is no code in the url to send, send a whoops! error message, else put the animated loading icon
